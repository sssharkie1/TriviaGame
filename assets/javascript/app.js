...
//     // This method will return the current value of the timer
        ...
        document.getElementById('btn').onclick = validate;
            ...
            function validate() {
              ...
              var wrong = 0; 
                ...
                var score = (100*right/(wrong+right)).toFixed(1);document.getElementById("score").innerHTML = 'Correct: '+ right +'<br/>Incorrect: ' + wrong;
            };  
